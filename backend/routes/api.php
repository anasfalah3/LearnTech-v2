...
Route::group(['middleware' => ['auth:sanctum']], function () {
    ...
    Route::post('/courses/save-course-image/{id}', [CourseController::class, 'saveCourseImage']);
    Route::post('/courses/change-course-status/{id}', [CourseController::class, 'changeStatus']);
